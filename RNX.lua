...
local Window = Library.CreateLib("Red Night", "BloodTheme") -- العنوان باللون الأحمر: Red Night
...
Fun:NewLabel("Use WASD + Space/Shift to move")

-- ========================
-- Minimize System (زر _)
-- ========================
...
for _,v in pairs(gui:GetChildren()) do
    if v:IsA("ScreenGui") and v ~= miniBtn then
        kavoUI = v
    end
end
